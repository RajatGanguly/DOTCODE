    ...
    <div>
      ...
      <div className="flex flex-wrap my-10 w-full mb-20 flex-col items-center text-center">
        ...
        <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">
          Start your journey today with our free courses with notes &
          assignments to boost your carrier
        </p>
      </div>
          ...
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-gray-200 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                A must before you join the GANG of developers, cause it's the
        ...
        <Link href={"/courses/css"}>
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-gray-200 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                Know the grammer of styles to make a presentable WEBSITE cause
                you need to make your site cool
              </p>
            </div>
          </div>
        </Link>
        <Link href={"/courses/js"}>
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-gray-200 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                The mostly used one in all LANGUAGE to gain mastery in the DEV
                community
              </p>
            </div>
          </div>
        ...
        <Link href={"/courses/node"}>
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-gray-200 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                Run time env to make you the king of SERVER and use JS wherever
                you want
              </p>
            </div>
          </div>
        ...
        <Link href={"/courses/mysql"}>
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-gray-200 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                Most simple yet popular RDBMS to handle DATABASE like a PRO
              </p>
            </div>
          </div>
        </Link>
        <Link href={"/courses/react"}>
          <div className="xl:w-1/3 md:w-1/2 p-4">
            <div className="border border-gray-200 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                JS Library by FACEBOOK to build web application in industry
                standards
              </p>
            </div>
          </div>
